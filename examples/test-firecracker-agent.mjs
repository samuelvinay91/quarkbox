...
async function runTests() {
  ...
  try {
    ...
    info('Provisioning a Firecracker MicroVM Sandbox...');
    ...
    success(`Firecracker VM Created: ID ${sandbox.id} (Status: ${sandbox.status})`);
...
print(json.dumps(data))
    ...
    info('Taking instantaneous Firecracker Guest Memory Snapshot...');
    ...
    // Cleanup
    if (sandbox) {
      info('Tearing down Firecracker MicroVM...');
